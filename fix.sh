...
CRI03=$( grep -ic "CRI-03" /etc/hostname ) #Check if the node is 03
CRI04=$( grep -ic "CRI-04" /etc/hostname ) #Check if the node is 04
...
echo "" && echo ""
if [ $CRI01 -eq 1 ] && [ $CRI02 -eq 1 ] && [ $CRI03 -eq 1 ] && [ $CRI04 -eq 1 ]
then
